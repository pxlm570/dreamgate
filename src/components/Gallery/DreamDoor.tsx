...
export function DreamDoor({
  ...
  return (
    <group ref={groupRef} position={position} rotation={[0, rotationY, 0]}>
      ...
      >
        <div className="flex flex-col items-center gap-1 rounded-lg border border-white/10 bg-black/45 px-3 py-1.5 backdrop-blur-md">
