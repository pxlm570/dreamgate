// Generation 组件 barrel 导出（Task 4：AI 梦境藏品生成）

export { AestheticOnboarding } from "./AestheticOnboarding";
export type { AestheticOnboardingProps } from "./AestheticOnboarding";
export { AiConsentDialog } from "./AiConsentDialog";
export type { AiConsentDialogProps } from "./AiConsentDialog";
